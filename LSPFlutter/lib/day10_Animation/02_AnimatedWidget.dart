...
// 创建AnimationController
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: LSPAnimatedIcon(animation: _tween),
      ),
...
class LSPAnimatedIcon extends AnimatedWidget {
  const LSPAnimatedIcon({super.key, required Animation animation}): super(listenable: animation);
